...
\multicolumn{3}{c}{\emph{   }}  \\
\multicolumn{3}{c}{\textbf{ {\huge Najd ELAOUD and Mohamed Selim TRIKI}}}\\
\end{tabular}
\vspace*{0.05cm}
...
\textbf{Presented $11$ July $2026$ in front of the jury members :}
\vspace*{1cm}
\begin{normalsize}
	\begin{description}
	\item [Mr. Nejib HASSEN \hspace{0.75cm}  ]\hfill  President 
	\item [Mr. Khaled ISSA   \hspace{0.75cm}   ] \hfill Professor
