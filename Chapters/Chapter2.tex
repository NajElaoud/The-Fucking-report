...
Its modular architecture allows different hardware modules and software functionalities to be integrated according to application requirements. This flexibility makes the IO-Box suitable for a wide range of industrial monitoring, automation, and data acquisition applications.
...
The M95M01‑RMN6TP is a 1‑Mbit serial EEPROM organized as 131,072 × 8 bits. It features a fast access time of 25 ns and communicates via the SPI bus, ensuring efficient integration with the STM32G474. Packaged in an 8‑pin SOIC format, it offers a compact solution suitable for embedded applications. Its endurance of up to one million write cycles and data retention of 40 years make it a robust choice for industrial environments where reliability is essential.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{Figures/eeprom.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Figures/ens210.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{Figures/hts221.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{Figures/vs_code.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Figures/stm32cubemx.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/endianness_diagram.png}
...
\begin{itemize}
    ...
    \item Wide industrial adoption.
    \item Interoperability between devices from different vendors.
    \item Reliable communication over long distances using RS485.
    \item Easy integration with supervisory and SCADA systems.
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/modbus_rtu_frame.jpg}
...
In the IO‑Box project, ADCs are employed to acquire signals from sensors and external modules, enabling precise monitoring and control. The STM32G474 microcontroller integrates multiple high‑resolution ADC channels, allowing simultaneous sampling of different inputs. This capability is particularly important in industrial contexts where multiple signals must be captured in real time.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\textwidth]{Figures/Duty_Cycle_Examples.png}
