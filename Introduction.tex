...
This report, which crowns the work entrusted to us, is structured around three chapters:
    ...
    \textbf{Chapter 2} introduces the general concept of the IOBox platform and describes the hardware components, software tools, communication protocols, sensors, and peripherals used throughout the project.
